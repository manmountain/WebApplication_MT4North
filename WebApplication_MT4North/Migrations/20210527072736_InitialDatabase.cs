...
namespace WebApplication_MT4North.Migrations
{
    public partial class InitialDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "BaseActivityInfos",
                columns: table => new
                {
                    BaseActivityInfoId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaseActivityInfos", x => x.BaseActivityInfoId);
                    table.ForeignKey(
                        name: "FK_BaseActivityInfos_Themes_ThemeId",
                        column: x => x.ThemeId,
            ...
            migrationBuilder.CreateTable(
                name: "CustomActivityInfos",
                columns: table => new
                {
                    CustomActivityInfoId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                    ThemeId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomActivityInfos", x => x.CustomActivityInfoId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomActivityInfos_Themes_ThemeId",
                        column: x => x.ThemeId,
                        principalTable: "Themes",
                        principalColumn: "ThemeId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaseActivityInfos_ThemeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomActivityInfos_ThemeId",
                table: "CustomActivityInfos",
                column: "ThemeId");
